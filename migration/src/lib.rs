...
mod m20230419_065718_create_kawasaki_group;
mod m20230419_073327_create_kawasaki_patient;
mod m20230419_135025_create_kawasaki_bloodtest;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            Box::new(m20230419_065718_create_kawasaki_group::Migration),
            Box::new(m20230419_073327_create_kawasaki_patient::Migration),
            Box::new(m20230419_135025_create_kawasaki_bloodtest::Migration),
